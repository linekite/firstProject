<%@ Page Language="C#" MasterPageFile="~/MainContent.Master" AutoEventWireup="true" CodeBehind="MessageDisease.aspx.cs" Inherits="Chm.Web.MessageDisease" %>
...
<tbody>
    <tr>
		<td>
			<div class="con">
			    <ul id="tags">
				   <li><a href="Message.aspx">公共短信模板</a> </li>
				   <li class="selectTag"><a href="javascript:void(0)">疾病短信模板</a> </li>
			    </ul>
				<div id="tagContent">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                               <tr>
                                ...
                                <tbody><tr>
                                    <td height="31" class="centset_bt">短信分类</td>
                                </tr>
                                <tr>
                                    <td valign="top">
...
<%--                                                                <asp:TemplateField ShowHeader="true" HeaderText="建议内容">
                                                                    <ItemTemplate>
                                                                        <Chy:XLabel ID="lblContent" runat="server"></Chy:XLabel>                                                                        
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>--%>
                                                                </Columns>
                                                                </Chy:XGridView>                                                                
...
<script language="javascript" type="text/javascript">
    ...
    OpenDialog = function () {
        ...
        if (id == "0" || id == "")          
            ...
            xysShowModal('公共短信模板库', 'TemplateQuery.aspx?type=1&GroupID=' + id, '1000', '500', '');
    }
...
//            }
//        })
        //javascript: WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$ctl00$MainlaceHolder1$MainlaceHolder$btnSearch&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false));
        //javascript: WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions('ctl00$ctl00$MainlaceHolder1$MainlaceHolder$btnSearch','', true, '', '', false, false));
        //javascript: __doPostBack('<%=btnSearch.UniqueID %>', '');
