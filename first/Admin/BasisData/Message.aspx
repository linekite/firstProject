<%@ Page Language="C#" MasterPageFile="~/MainContent.Master" AutoEventWireup="true" CodeBehind="Message.aspx.cs" Inherits="Chm.Web.Message" %>
...
<tbody>
    <tr>
		<td>
			<div class="con">
			    <ul id="tags">
                  <li><a href="MsgDisease.aspx?groupID=0&MType=1">疾病短信模板</a> </li>
				   <li class="selectTag"><a href="javascript:void(0)">公共短信模板</a> </li>				   
			    </ul>
				<div id="tagContent">
...
<%--                                                  <Chy:XGridView  ID="gvType" runat="server" CssClass="fz_template"  AllowPaging="true"   DataKeyNames="TemplatetypeID"
                          ...
                          CommandArgument='<%#Eval("TemplatetypeID")%>' OnCommand="gvType_Command" Text='<%#Eval("Name") %>'><%#Eval("Name") %></asp:LinkButton>                                                                       
                                ...
                                <td align="center" valign="top" width="70%">
                                     <table cellspacing="0" cellpadding="0" border="0" align="right" width="98%" class="cent_set">
                                                        <tbody><tr>
                                                        <td height="31" class="centset_bt" align="left"><Chy:XLabel runat="server" ID="lblType"></Chy:XLabel>短信内容</td>
                                                        </tr>
                                                        <tr>
                                                        <td>
           ...
           AutoGenerateColumns="False" PagerSettings-PageButtonCount="8" PageSize="10" width="100%" OnRowDataBound="gvShow_RowDataBound" OnBindCstm="gvShow_BindCstm">
                                                                <Columns>
                                                                <asp:TemplateField HeaderStyle-CssClass="check" ItemStyle-Width="10px" ItemStyle-CssClass="check">
                                                                    <HeaderTemplate>
...
<table cellspacing="0" cellpadding="0" border="0" class="formcontainer">
		  <tbody><tr>
			<td class="label" colspan="2">
              <Chy:XTextBox ID="txtTypeName" MaxLength="50" runat="server" CssClass="inputtext"></Chy:XTextBox>			 
			</td>
		   </tr>		   
		  </tbody></table>
 <table cellspacing="0" cellpadding="0" border="0" align="center">
...
<script language="javascript" type="text/javascript">
    ...
    function showDiv8(smsid, tmpcontent) {
        ...
        $("#popDiv8").dialog({ autoOpen: true, width: 350, height: 250, showTitle: true, modal: true, title: "编辑短信" }); 
...
//        document.getElementById('bg').style.display = 'block';
    ...
    function showDiv9(smsid) {
        ...
        $("#popDiv9").dialog({ autoOpen: true, width: 350, height: 150, showTitle: true, modal: true, title: "编辑短信类别" }); 
...
//        document.getElementById('popIframe').style.display = 'none';
    ...
    function delColor(id) {
        //alert($("#<%=gvType.ClientID %>").children().find("tr").eq(1).find("a").attr("style"));
      ...
      $("#" + id).attr("style", "font-weight:bold");      
        //$("#<%=gvType.ClientID %>").children().find("tr").eq(1).find("a").removeAttr("style");
  }
