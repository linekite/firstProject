<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckItemSelectAm.aspx.cs" Inherits="Chm.Web.Admin.Checkup.CheckItemSelectAm" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title></title>    
    <%--<link type="text/css" rel="Stylesheet" href="/CSS/control.css" />--%>
    <link type="text/css" rel="Stylesheet" href="/CSS/AM/jquery-ui-1.8.11.custom.css" />
    <script src="/Js/jquery-1.4.1.min.js" type="text/javascript"></script>  
    <script src="/Js/jquery-ui-1.8.11.custom.min.js" type="text/javascript"></script>
    <link type="text/css" rel="Stylesheet" href="/App_Themes/default/css/base.am.css" />
...
<body class="noauto" style="background:#fff">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="addformcontainer" >
        <tr>
            <td>
                <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="addformcontainer">
                    <tr>
                        <td>
                            <div class="con">
                                <ul id="tags">
                                ...
                                <div id="tagContent">
                                    <div class="tagContent selectTag" id="tagContent0">
                                      ...
                                      <%--  <table width="99%" cellpadding="0" cellspacing="0" align="center" class="zebratable">
                                            <tr>
                                                <td>--%>
                                                    <Chy:XGridView ID="gvCheckItem" runat="server" CssClass="zebratable" AllowPaging="true"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-CssClass="check" ItemStyle-Width="3px" ItemStyle-CssClass="check">
                                                                <HeaderTemplate>
