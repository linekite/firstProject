<%@ Page Language="C#" MasterPageFile="~/AmMainContent.Master" AutoEventWireup="true"
    CodeBehind="CheckupReportMemerAdd.aspx.cs" Inherits="Chm.Web.Admin.Checkup.CheckupReportMemerAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainlaceHolder" runat="server">
    <table width="100%" class="searchPanel1">
        ...
        <tr>
         ...
         <td class="tata">
            ...
            <td class="tata">
                <span class="tbtb">
                    <Chy:XDatePicker ID="dpCheckDate" runat="server" AllowEmpty="false" ValidationGroup="DoctorValid" onchange="fillDate()"
    ...
    <table width="100%" cellspacing="2" cellpadding="0" class="combination">
        ...
        <tr>
            <td>
                <span>
                    <asp:TextBox ID="txtClassName" runat="server" CssClass="inputtext" MaxLength="28">
                    </asp:TextBox><asp:TextBox ID="txtClassID" runat="server" Style="display: none"></asp:TextBox>&nbsp;<asp:ImageButton
  ...
  function fillDate()
        ...
        function OpenClassSelect() {
            ...
            $("<div style='width:100%;height:375px' id='divchooseFrame'><iframe  scrolling='auto' width='100%' height='100%'  frameborder=0  id='ChooseFrame' src='" + url + "' /></div>").dialog({ autoOpen: true, width: 660, height: 390, showTitle: false, modal: true, title: '选择组合项目' });
        }
        ///
