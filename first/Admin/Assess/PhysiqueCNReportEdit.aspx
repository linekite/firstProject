<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhysiqueCNReportEdit.aspx.cs" Inherits="Chm.Web.Admin.Assess.PhysiqueCNReportEdit" %>
...
<body>
 ...
 <div id="subject">
 <asp:UpdatePanel ID="upPhysique" runat="server" UpdateMode="Conditional">
  <ContentTemplate>
   <div class="chunk">
     <!--头部-->
     ...
     <div class="chunk_matter">
       ...
       <div class="jiantoua_tishi">
         ...
         <div class="xingge_tishi_wenzi">您的体质&nbsp;
            <Chy:XDropDownList ID="ddlPhysiqueType1" OnTextChanged="ddlPhysiqueType1_TextChanged" runat="server" AutoPostBack="true">
            </Chy:XDropDownList>
         &nbsp;
            <Chy:XDropDownList ID="ddlPhysiqueStatus1" runat="server" AutoPostBack="false">
            </Chy:XDropDownList>
          </div>
   ...
   <div class="chunk" runat="server" id="divIrr2" visible="false">
     ...
     <div class="chunk_matter">
       ...
       <div class="jiantoua_tishi">
         <div class="xingge_tishia"><img src="../../image/jiankang_42.gif" /></div>
         <div class="xingge_tishi_wenzi">您的体质&nbsp;
             <Chy:XDropDownList ID="ddlPhysiqueType2" OnTextChanged="ddlPhysiqueType2_TextChanged" runat="server" AutoPostBack="true">
            </Chy:XDropDownList>&nbsp;
            <Chy:XDropDownList ID="ddlPhysiqueStatus2" runat="server" AutoPostBack="false">
            </Chy:XDropDownList></div>
         <div class="xingge_tishib"><img src="../../image/jiankang_46.gif" /></div>
         <div style="clear:both"></div>
       </div>
       <div class="distance"></div>
...
牛奶羊肉汤：羊肉200克，牛奶200克，山药100克。做法：羊肉洗尽切块，山药洗尽切片，生姜洗尽切碎。将羊肉和生姜同入砂锅，小火炖两三小时，直至肉烂，然后加入山药同煮，直至山药熟烂，最后加入牛奶，煮沸即可。吃肉喝汤，每周一次。可温中补虚，益精补气。
   ...
   <div class="distance"></div>
    <div style="text-align:center">
        <Chy:XButton ID="btnSave" runat="server" Text='' OnClick="btnSave_Click" />
        &nbsp;&nbsp;<input type="hidden" runat="server" id="hidenID" />
        &nbsp;&nbsp;<input runat="server" id="hideExamineTime" type="hidden" /><input runat="server" id="hideSpace" type="hidden" value="0" />
       <Chy:XButton ID="btnCancel" runat="server"   ValidationGroup="EditVal" Text="关闭" CssClass="button" OnClientClick="window.close();" />
     </div>
